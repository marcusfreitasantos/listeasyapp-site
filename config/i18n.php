...
$translations = [
    'pt-BR' => [
        ...
        'footer.data_delete_title' => 'Deseja excluir todos os seus dados do aplicativo?',
        'footer.data_delete_text' => 'Se voce quiser solicitar a remocao completa dos dados vinculados ao seu uso do ListEasy, entre em contato por e-mail. Sua solicitacao sera analisada e respondida em tempo razoavel.',
        'footer.data_delete_button' => 'Enviar e-mail para exclusao de dados',
    ...
    'en' => [
        ...
        'footer.data_delete_title' => 'Would you like to delete all your app data?',
        'footer.data_delete_text' => 'If you want to request the complete removal of data linked to your use of ListEasy, contact us by email. Your request will be reviewed and answered within a reasonable time.',
        'footer.data_delete_button' => 'Email us to delete your data',
