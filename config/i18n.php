...
$translations = [
    'pt-BR' => [
        ...
        'home.hero.body' => 'Um app que ajuda você a criar listas de compras bonitas, objetivas e prontas para serem usadas em conjunto.',
    ...
    'en' => [
        ...
        'home.hero.body' => 'An app that helps you build beautiful, practical shopping lists that are ready to use together.',
